# A new version of RESEO has been released
> **Warning**: This repository will be kept archived in the state of the ontology as described in the artivle, but a new, FAIR compliant version has been released at [KhaosResearch/REmoteSEnsingOntology](https://github.com/KhaosResearch/REmoteSEnsingOntology) and the documentation is hosted at [https://w3id.org/reseo](https://w3id.org/reseo).
